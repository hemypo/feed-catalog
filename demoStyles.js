   ...
   (function () {
    ...
    demoStyles.innerHTML = `
        ...
        .mc-demo-trigger {
            ...
            cursor: pointer; box-shadow: 0 12px 24px rgba(26,27,34,0.3);
        ...
        .mc-demo-panel {
            ...
            box-shadow: 0 24px 80px rgba(0,0,0,0.15); z-index: 9998;
        ...
        <div class="mc-demo-panel" id="mc-demo-panel">
            ...
            <div class="mc-demo-body">
                ...
                <div class="mc-demo-section">
                    ...
                    <div class="mc-demo-row">
                        <span class="mc-demo-row-text">Блок «В кредит»</span>
                        <label class="mc-demo-switch"><input type="checkbox" id="demo-tog-credit" checked><div class="mc-demo-slider"></div></label>
                    </div>
                    <div class="mc-demo-row">
                        <span class="mc-demo-row-text">Текстовое описание</span>
                        <label class="mc-demo-switch"><input type="checkbox" id="demo-tog-desc" checked><div class="mc-demo-slider"></div></label>
                    </div>
                </div>
    ...
    document.getElementById('demo-layout').addEventListener('change', (e) => {
        if (catalogRoot) catalogRoot.setAttribute('data-filter-layout', e.target.value);
    });
            ...
            const html = `
                <div class="mc-demo-row">
                    ...
                    <label class="mc-demo-switch">
                        <input type="checkbox" checked data-filter-target="${key}">
                        <div class="mc-demo-slider"></div>
                    </label>
                </div>
            `;
